...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   calico_kitty_dialogues.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: riamaev <riamaev@student.hive.fi>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/06 09:54:08 by riamaev           #+#    #+#             */
/*   Updated: 2025/04/06 10:08:33 by riamaev          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**get_calico_kitty_dialogues(int index)
{
	return (g_calico_kitty_dialogues[index]);
}
